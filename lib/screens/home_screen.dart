  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        // Uses theme's FAB color which is set from accent in AppTheme.build()
...
class _StatsPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          _StatCard(value: '${provider.doneToday}/${provider.totalHabits}', label: 'Done today'),
          const SizedBox(width: 8),
          _StatCard(value: '${provider.bestCurrentStreak}', label: 'Best streak'),
          const SizedBox(width: 8),
          _StatCard(value: '${provider.totalHabits}', label: 'Habits'),
        ],
      ),
    );
  }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('No habits yet', style: TextStyle(
